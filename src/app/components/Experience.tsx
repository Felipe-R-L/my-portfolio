...
import { Database, Map, Radio, LineChart, Server, MonitorSmartphone, BrainCircuit } from "lucide-react";
  ...
  const experiences = [
    {
      ...
      description: "Leading the development of the OMDfarm SaaS platform, a high-performance solution for the agribusiness sector.",
      glow: "rgba(59, 130, 246, 0.5)",
      spotlightColor: "rgba(59, 130, 246, 0.12)",
      accentColor: "from-blue-400 via-indigo-400 to-purple-400",
      highlights: [
        { icon: Map, text: "Interactive integrations with Google Maps API for planting failure analysis, showcased at Agrishow." },
        { icon: Radio, text: "MQTT integration for real-time machinery tracking and telemetry data ingestion." },
        { icon: Database, text: "Architected high-volume data ingestion queues using BullMQ and TimescaleDB." },
        { icon: LineChart, text: "Query optimization in Google Cloud SQL and development of rich B.I. Dashboards using ECharts." }
      ]
    },
    {
      company: "IT Consulting & Dallas Motel",
      role: "Strategic IT & Lead Developer",
      description: "Driving digital transformation, strategic IT decisions, and building a custom operational ecosystem.",
      glow: "rgba(168, 85, 247, 0.5)",
      spotlightColor: "rgba(168, 85, 247, 0.12)",
      accentColor: "from-purple-400 via-pink-400 to-rose-400",
      highlights: [
        { icon: MonitorSmartphone, text: "Implemented a fully digital menu and an in-room media streaming server." },
        { icon: Server, text: "Ongoing architecture and development of a custom PMS (Property Management System)." },
        { icon: BrainCircuit, text: "Building an AI-powered finance dashboard designed to drastically reduce operational costs." }
      ]
    }
  ];
                    ...
                    {exp.highlights.map((highlight, hIdx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          whileInView={{ opacity: 1, y: 0 }}
                          viewport={{ once: true }}
                          transition={{ duration: 0.5, delay: 0.4 + hIdx * 0.1 }}
                        ...
                        >
                          ...
                          <p className="text-gray-400 leading-relaxed text-sm md:text-base font-light group-hover:text-gray-300 transition-colors">{highlight.text}</p>
                        </motion.div>
                      );
                    })}
                  </div>
